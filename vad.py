...
def vad_plotter(radar_id, storm_motion='right-mover', sfc_wind=None, time=None, fname=None, local_path=None, 
                cache_path=None, web=False, fixed=False, dark=False):
    plot_time = None
    if time:
    ...
    plot_hodograph(vad, params, fname=fname, web=web, fixed=fixed, archive=(local_path is not None), dark=dark)
...
def main():
    ...
    ap.add_argument('--dark', dest='dark', action='store_true', help="Enable dark mode for the plot.")
    args = ap.parse_args()
